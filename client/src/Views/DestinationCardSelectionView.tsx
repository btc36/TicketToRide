    ...
    return (
      <form onSubmit={component.onSubmitButtonPressed}>
        <p>Destination Card A----City1: {component.state.destinationCards[0].city1} , City2: {component.state.destinationCards[0].city2}, Points: {component.state.destinationCards[0].pointValue}</p><p>
          ...
          if(component.state.destinationCards.length == 1)
          {
              return (
                  <form onSubmit={component.onSubmitButtonPressed}>
                      <p>Destination Card A----City1: {component.state.destinationCards[0].city1} , City2: {component.state.destinationCards[0].city2}, Points: {component.state.destinationCards[0].pointValue}</p><p>
                  </p><p></p><p>
                      <input type="radio" name="discard" defaultValue="g" onChange={component.onSelectCard} checked={component.state.toDiscard === "g"} /> keep this<br /><br />
                      <input type="submit" defaultValue="Submit" />
                  </p></form >
              );
          }
          else if(component.state.destinationCards.length == 2)
          {
              return (
                  <form onSubmit={component.onSubmitButtonPressed}>
                      <p>Destination Card A----City1: {component.state.destinationCards[0].city1} , City2: {component.state.destinationCards[0].city2}, Points: {component.state.destinationCards[0].pointValue}</p><p>
                      ...
                      <input type="radio" name="discard" defaultValue="h" onChange={component.onSelectCard} checked={component.state.toDiscard === "h"} /> Discard A<br />
                      <input type="radio" name="discard" defaultValue="i" onChange={component.onSelectCard} checked={component.state.toDiscard === "i"} /> Discard B<br />
                      <input type="radio" name="discard" defaultValue="j" onChange={component.onSelectCard} checked={component.state.toDiscard === "j"} /> Keep all 2<br /> <br />
                      <input type="submit" defaultValue="Submit" />
                  </p></form >
              );
          }
      ...
      return (
          <form>
              <p>Dest Cards have been Selected!</p>
